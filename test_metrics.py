...
class Tester():
    def __init__(self, opt):
        ...
        # gen_path = '/mnt/lustre/sunjixiang1/code/DifFace/logs/06201639/ckpts/model_80000_gen.pth'
    ...
    def val(self):
        ...
        for idx, val_data in enumerate(dataloader):
            ...
            dir = 'tmp/val'
            save_img_path = os.path.join(dir, 'lq_dist', os.path.basename(val_data['lq_path'][0]))
            save_gt_img_path = os.path.join(dir, 'gt_dist', os.path.basename(val_data['gt_path'][0]))
            #     else:
        ...
        with torch.no_grad():
            ...
            while i < n:
                ...
                if isinstance(self.net_g, nn.parallel.DistributedDataParallel):
                    pred = self.net_g.module.ddim_sample(self.lq[i:j, :, :, :], False)
                else:
                    pred = self.net_g.ddim_sample(self.lq[i:j, :, :, :], False)
