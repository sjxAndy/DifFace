...
def main():
    ...
    for ii, im_path in enumerate(im_path_list):
        ...
        if args.aligned:
            ...
            #         )[0] #[0,1], 'rgb'
            face_restored, im_hq = sampler_dist.sample_func_ir_aligned(
                    y0=im_lq,
                    start_timesteps=args.started_timesteps,
                    need_restoration=False,
                    )
            ...
            util_image.imwrite(im_hq, 'tmp/hq.png', chn='bgr', dtype_in='uint8')
        else:
