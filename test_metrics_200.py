...
class Tester():
    ...
    def val(self):
        ...
        for idx, val_data in enumerate(dataloader):
            ...
            dir = 'tmp/val'
            save_img_path = os.path.join(dir, 'lq_2000', os.path.basename(val_data['lq_path'][0]))
            save_gt_img_path = os.path.join(dir, 'gt_2000', os.path.basename(val_data['gt_path'][0]))
            #     else:
    ...
    def test(self):
        ...
        with torch.no_grad():
            ...
            while i < n:
                ...
                # HQ = self.net_g.super_resolution(self.lq[i:j, :, :, :], False)
